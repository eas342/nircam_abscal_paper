...
\item {\bf Metallicity} Ideally, the cluster should have near-solar metallicity. NGC 2420 and NGC 6811 have -0.08 $<=$ [Fe/H] $<=$ 0.05. NGC 2506, is metal poor at [Fe/H]=-0.32.
...
\item {\bf Visibility} The clusters should be spread out to ensure that at least one is visible during the commissioning period.
\end{itemize}

With all these considerations in play, we selected NGC 2420 as the best fit for the multiple criteria.
NGC 2506 and NGC 6811 are next-best fits and have somewhat complimentary visibility windows, visible in Figure \ref{fig:clusterVis}.
