...
The same configuration can then be used on 
...
\hline \hline
1		& Direct Calibrator\tablenotemark{a}	& A1 V- G2 V		& -1.35		& On	&	32$\times$32	& F466N	& 0.1 \\
2		& Medium Calibrator				& G2 V			& 12  		& On  &	32$\times$32	& F466N  &  \\
3		& Medium Calibrator				& G2 V			& 6  			& Off &	32$\times$32	& F466N  &  \\
4		& Faint Calibrator				& G2 V			& 16 			& Off &	32$\times$32	& F466N  &  \\
5		& Faint Calibrator				& G2 V			& 16 			& Off &	Full Frame	& F466N  &  \\
6		& Faint Calibrator				& G2 V			& 16 			& Off &	Full Frame  	& F444W  &  \\
\hline
\end{tabular}
\tablenotetext{a}{Any directly calibrated bright source such as the MSX calibrators \citep{price2004msxCal}, Sirius, $\alpha$ Cen A or Vega.}
\vspace{0.05in}
\end{table}

\begin{figure}[!hbtp]
\centering
\includegraphics[width=.7\columnwidth]{sensitivity_ladder.pdf}
\caption{Sensitivity ladder going from a narrowband, sub-array, neutral density filter observation of Sirius all the way to a wide band, full array, non-neutral density filter of a faint calibrator.}\label{fig:sensitityLadder}
\end{figure}
...
\item Use a neutral density square in the coronagraph mask. The neutral density filters have an attenuation of around 10$^2.6$ or 6.5 mags. A color correction would have to be applied for the neutral density filter (since it is wavelength dependent) when transferring to an un-occulted region. Additionally, the Lyot stop that must be in place to use the neutral density filter has a throughput of 19\%, so the total improvement is 8.3 mags
