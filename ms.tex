...
\hline
\end{tabular}
\tablenotetext{a}{Any directly calibrated bright source such as the MSX calibrators \citep{price2004msxCal}, (which include Sirius and Vega) or alternatively $\alpha$ Cen A.}
\vspace{0.05in}
\end{table}
