...
If one assumes an extinction of E(B-V) = 0.05 and a Galactic average extinction law \citep{cardelli1989}, the visual distance moduli $(m- M)_V$ should be an additional 0.1 mag.
...
Accurate positioning can help align the source to the same location on the neutral density square and dithering can be used to check the surface irregularities.
