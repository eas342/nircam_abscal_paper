...
However, if sufficient time is available for calibration, it is possible to convert from an MSX standard to full frame imaging in a narrowband mode in one step by using an intermediate JWST standard.
