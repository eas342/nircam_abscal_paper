...
Figure \ref{fig:sensitivityLadder} shows a schematic of the steps.
NIRCam can observe the the Midcourse Survey Experiment (MSX) calibrators \citep{price2004msxCal}, as discussed in Section \ref{sec:brightStarMode}.
The same instrument configuration, source location would be used to transfer to a JWST standard.
...
\hline \hline
Step		& Source						& Spectral Type	& K Mag		& ND Filter		& Subarray	& Filter & t$_{exp} (s) $\\
\hline \hline
1		& MSX Calibrator\tablenotemark{a}	& A1 V to M0 III		& -3 to 0.1		& On	&	64$\times$64	& F430M &  0.2 \\
2		& Bright JWST Calibrator			& G2 V			& 6	  		& On &	64$\times$64	& F430M &  220 \\
3		& Bright JWST Calibrator			& G2 V			& 6  			& Off &	64$\times$64	& F430M &  0.1 \\
4		& Faint Calibrator				& G2 V			& 16 			& Off &	64$\times$64	& F430M &  94 \\
5		& Faint Calibrator				& G2 V			& 16 			& Off &	Full Frame	& F430M &  107 \\
6		& Faint Calibrator				& G2 V			& 16 			& Off &	Full Frame  	& F444W &  21 \\
\hline
\end{tabular}
\tablenotetext{a}{Any directly calibrated bright source such as the MSX calibrators \citep{price2004msxCal}, (which include Sirius and Vega) or alternatively $\alpha$ Cen A. The exposure times given are the times needed to reach at least SNR=200, rounded up to the next group up the ramp.}
\vspace{0.05in}
\end{table}



\subsection{Ways to Observe Really Bright Stars With NIRCam}\label{sec:brightStarMode}
