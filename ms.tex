...
Figure \ref{fig:msxNCfilterOverlap} shows the MSX filters B1 and B2 as compared to the NIRCam long wavelength filters with some overlap and that the F430M filter most closely matches the MSX bands.
