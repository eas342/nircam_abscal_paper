...
\caption{We observed additional stars with Hectospec on the MMT search for additional G2~V sources. This shows the same plot as Figure \ref{figNCFOV} after a second Hectospec fiber configuration.
